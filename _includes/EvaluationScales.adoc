...
--
In the current interface, the impact-scale area is labelled `Impact evaluation (severity of consequences)`.
This wording clarifies that impact represents the severity of consequences while keeping the same MONARC impact model and calculations.
--
