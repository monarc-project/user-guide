...
8.	`Category`: It is the location in the library where the asset will be stored, or create a new category.
9.	`Operational risk Tag`: , that allows the asset to be associated with operational risks by default.
+
...
10.	`Location`: Allows you to order assets in the selected category.
