...
image: Administration_1.png[Administration,pdfwidth=20%,width=20%,align=center]
...
Then, click on the ‘Permissions and Roles’ option to change the screen, where you can choose from three options: Administrator, User, or Global dasboard.
